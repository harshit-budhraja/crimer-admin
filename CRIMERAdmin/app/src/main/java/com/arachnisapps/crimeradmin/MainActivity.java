...
package com.arachnisapps.crimeradmin;
...
public class MainActivity extends AppCompatActivity{
    ...
    private String projecturl="https://thecrimerproject.firebaseio.com";
    private com.arachnisapps.crimeradmin.AppController appController;
...
//                break;
        ...
        StringRequest request =new StringRequest
                (Request.Method.GET, url, new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Log.v("LEARN",response + " " + url.substring(0, url.indexOf("/.json")));
                        if (response != null) {
    ...
    /*private void onBaseUrlRequest(final String url) {
        StringRequest request =new StringRequest
                (Request.Method.GET, url, new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
